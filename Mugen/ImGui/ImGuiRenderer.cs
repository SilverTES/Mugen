...
namespace Mugen.ImGui
{
    ...
    public class ImGuiRenderer
    {
        ...
        /// </summary>
        protected virtual void UpdateInput(float mouseX, float mouseY, float displaySizeW, float displaySizeH, float displayScaleX = 1f, float displayScaleY = 1f)
        {
            ...
            io.DisplaySize = new System.Numerics.Vector2(displaySizeW, displaySizeH);
            //io.DisplaySize = new System.Numerics.Vector2(_graphicsDevice.PresentationParameters.BackBufferWidth, _graphicsDevice.PresentationParameters.BackBufferHeight);
            io.DisplayFramebufferScale = new System.Numerics.Vector2(displayScaleX, displayScaleY);
        }
